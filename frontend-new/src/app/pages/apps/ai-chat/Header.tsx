...
const engines: Engine[] = [
  { id: randomId(), name: "چت‌جی‌پی‌تی o3" },
  { id: randomId(), name: "چت‌جی‌پی‌تی 4o" },
  { id: randomId(), name: "چت‌جی‌پی‌تی 4o پرو" },
  { id: randomId(), name: "کوپایلوت پرو" },
];
    ...
    >
      ...
      <div className="flex gap-2">
        ...
        >
          ...
          <span className="max-sm:hidden">تست AI Pro</span>
        </Button>
      </div>
    </header>
  );
