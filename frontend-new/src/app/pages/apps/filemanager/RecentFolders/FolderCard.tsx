...
export function FolderCard({ name, color, size, filesCount }: Folder) {
  return (
    <Card className="p-3 pt-4">
      ...
      <div
        className={`text-this dark:text-this-light pt-5 text-base font-medium tracking-wide this:${color}`}
      >
        {name}
      </div>
      <div className="mt-1.5 flex items-center justify-between">
        ...
        <p className="dark:text-dark-100 font-medium text-gray-800">{size}</p>
      </div>
    </Card>
  );
}

function FolderIcon({ color }: { color: Folder["color"] }) {
  return (
    <svg
      className="w-14"
      viewBox="0 0 329 198"
