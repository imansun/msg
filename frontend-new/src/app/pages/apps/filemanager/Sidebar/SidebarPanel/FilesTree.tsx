...
const tree: TreeNode[] = [
  {
    ...
    title: "طراحی",
    children: [
      { id: randomId(), title: "وب اپلیکیشن‌ها" },
      {
        id: randomId(),
        title: "برنامه‌های CRM",
        children: [
          { id: randomId(), title: "برنامه LMS" },
          { id: randomId(), title: "فروشگاه اینترنتی" },
          { id: randomId(), title: "داشبوردها" },
        ],
      },
      { id: randomId(), title: "برنامه‌های دسکتاپ" },
      { id: randomId(), title: "برنامه‌های موبایل" },
    ],
  },
  {
    id: randomId(),
