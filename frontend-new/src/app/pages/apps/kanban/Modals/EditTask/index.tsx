...
import { colors, Task, Column } from "../../data";
...
const schema = Yup.object().shape({
  title: Yup.string().required("لطفاً عنوان تسک را وارد کنید"),
  labels: Yup.array(),
  members: Yup.array(),
  description: Yup.string(),
  dueDate: Yup.date().optional(),
  color: Yup.string().required("لطفاً رنگ را وارد کنید").oneOf(colors),
});
  ...
  return (
    ...
    >
      ...
      <TransitionChild
        ...
        leaveFrom="opacity-100"
        leaveTo="opacity-0"
        className="hide-scrollbar dark:bg-dark-700 relative flex h-full w-full max-w-4xl flex-col overflow-y-auto bg-white p-4 transition-opacity duration-300 sm:rounded-lg sm:px-5"
      >
    ...
    >
      ...
      <div className="mt-6 flex justify-between">
        ...
        >
          ...
          <div className="max-md:hidden">حذف</div>
        </Button>
