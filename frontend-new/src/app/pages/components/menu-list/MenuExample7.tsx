  ...
  <li>
    <button
      className={clsx(
        ...
        active
          ? "bg-gray-150 text-gray-800 dark:bg-surface-1 dark:text-dark-50"
          : "hover:text-gray-800 focus:bg-gray-100 focus:text-gray-800 dark:hover:bg-surface-2 dark:hover:text-dark-100 dark:focus:bg-dark-600 dark:focus:text-dark-100"
      )}
