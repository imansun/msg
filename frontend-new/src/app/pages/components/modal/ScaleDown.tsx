...
const frequents: Frequents[] = [
  { key: "kanban", title: "کنبان", color: "secondary", Icon: ViewColumnsIcon },
  {
    key: "chat",
    title: "گفتگو",
    color: "success",
  ...
  { key: "banking", title: "بانکداری", color: "warning", Icon: ScaleIcon },
  { key: "orders", title: "سفارشات", color: "info", Icon: ShoppingBagIcon },
  { key: "sales", title: "فروش", color: "success", Icon: CurrencyDollarIcon },
];

const suggestions: Suggestion[] = [
  { key: "chat", title: "اپلیکیشن گفتگو", Icon: ChatBubbleLeftEllipsisIcon },
  { key: "filemanager", title: "مدیریت فایل", Icon: CloudIcon },
  { key: "email", title: "اپلیکیشن ایمیل", Icon: EnvelopeIcon },
  { key: "kanban", title: "برد کنبان", Icon: ViewColumnsIcon },
  { key: "crypto", title: "داشبورد رمزارز", Icon: CurrencyPoundIcon },
  { key: "banking", title: "داشبورد بانکداری", Icon: ScaleIcon },
  { key: "analytics", title: "داشبورد تحلیل", Icon: ArrowTrendingUpIcon },
];
...
export function ScaleDown() {
  ...
  return (
    <>
      <Button onClick={open}>بزرگ‌نمایی</Button>
