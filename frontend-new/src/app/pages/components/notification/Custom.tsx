  ...
  >
    ...
    <span className="flex-1">
      <Marquee pauseOnHover gradient={false}>
        من می‌توانم یک کامپوننت ری‌اکت باشم، چندین کامپوننت ری‌اکت باشم، یا فقط مقداری متن باشم. من می‌توانم یک کامپوننت ری‌اکت باشم، چندین کامپوننت ری‌اکت باشم، یا فقط مقداری متن باشم. من می‌توانم یک کامپوننت ری‌اکت باشم، چندین کامپوننت ری‌اکت باشم، یا فقط مقداری متن باشم. من می‌توانم یک کامپوننت ری‌اکت باشم، چندین کامپوننت ری‌اکت باشم، یا فقط مقداری متن باشم.
      </Marquee>
    </span>
    <div>
      <Button
