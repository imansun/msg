...
const solutions: Solution[] = [
  {
    name: "بینش‌ها",
    description: "اقداماتی که کاربران شما انجام می‌دهند را اندازه‌گیری کنید",
    href: "##",
    icon: IconOne,
  },
  {
    name: "خودکارسازی‌ها",
    description: "محتوای هدفمند خود را ایجاد کنید",
    href: "##",
    icon: IconTwo,
  },
  {
    name: "گزارش‌ها",
    description: "رشد خود را پیگیری کنید",
    href: "##",
    icon: IconThree,
  },
];
...
export function Links() {
  return (
    <Popover className="relative w-full">
      <PopoverButton as={Button}>شروع</PopoverButton>
      <Transition
        as={Fragment}
        ...
        >
          ...
          <div className="bg-gray-100 px-7 py-4 dark:bg-dark-800">
            ...
            <span className="mt-1 block text-sm">
              یکپارچه‌سازی محصولات و ابزارها را شروع کنید
            </span>
          </div>
        </PopoverPanel>
      </Transition>
