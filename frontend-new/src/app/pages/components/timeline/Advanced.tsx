  ...
  return (
    <div className="max-w-sm">
      <Timeline pointSize="1.5rem">
        ...
        >
          <p> جان دو عکس پروفایل خود را تغییر داد </p>
          <Avatar
            size={20}
            classNames={{
              root: "mt-2",
        ...
        >
          <p>مورس کلارک یک گالری تصویر جدید اضافه کرد</p>
        ...
        >
          <p>رابرت نولان طراحی نرم‌افزار CRM را به پایان رساند</p>
          <a
            href="##"
        ...
        >
          <p>تیم اپلیکیشن نمودار ER را تکمیل کرد</p>
          <div className="mt-1">
            <p className="text-xs text-gray-400 dark:text-dark-300">اعضا:</p>
        ...
        >
          <p className="mt-1">گزارش هفتگی بارگذاری شد</p>
        </TimelineItem>
      </Timeline>
    </div>
  );
