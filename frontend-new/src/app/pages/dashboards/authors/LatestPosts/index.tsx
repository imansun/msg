...
const posts: Post[] = [
  ...
  },
  {
    ...
    title: "چگونه به اینجا رسیدیم؟ تاریخچه موسیقی از طریق توییت‌ها",
    description: "لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ.",
    author_name: "هنری کرتیس",
  ...
  },
  {
    ...
    title: "PHP چیست؟",
    description:
      "چگونه به اینجا رسیدیم؟ تاریخچه موسیقی از طریق توییت‌ها",
    author_name: "تراویس فولر",
  ...
  },
  {
    ...
    title: "غذا: تعریفی ساده",
    description:
      "لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ. آیا به چیزهای ضروری نیاز دارید؟",
    author_name: "جان دو",
