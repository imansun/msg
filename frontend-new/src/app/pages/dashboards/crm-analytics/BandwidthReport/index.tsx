      ...
      <div className="grid grid-cols-1 gap-4 px-4 sm:gap-5 sm:px-5 lg:grid-cols-2">
        <div className="border-gray-150 dark:border-dark-600 rounded-lg border p-4">
          <div className="flex justify-between">
            ...
            <p className="text-xs-plus">ترافیک HTTP</p>
          </div>
        ...
        <div className="border-gray-150 dark:border-dark-600 rounded-lg border p-4">
          <div className="flex justify-between">
            ...
            <p className="text-xs-plus">ترافیک SMTP</p>
          </div>
        ...
        <div className="border-gray-150 dark:border-dark-600 rounded-lg border p-4">
          <div className="flex justify-between">
            ...
            <p className="text-xs-plus">ترافیک FTP</p>
          </div>
        ...
        <div className="border-gray-150 dark:border-dark-600 rounded-lg border p-4">
          <div className="flex justify-between">
            ...
            <p className="text-xs-plus">ترافیک POP3</p>
          </div>
      ...
      <div className="mt-4 grow px-4 sm:px-5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <p className="text-xs-plus">عملکرد</p>
