...
const projects: Project[] = [
  {
    uid: 1,
    name: "طراحی وب",
    description: "طراحی سیستم مدیریت یادگیری",
    color: "info",
    category: "طراحی رابط کاربری/تجربه کاربری",
    progress: 55.23,
    created_at: "۱۸ خرداد ۱۴۰۰",
    teamMembers: [
      {
        uid: "5",
        name: "کاترینا وست",
  ...
  },
  {
    ...
    description: "اپلیکیشن تجارت الکترونیک",
    color: "secondary",
    category: "تجارت الکترونیک",
    progress: 14.84,
    created_at: "۱۱ اردیبهشت ۱۴۰۰",
    teamMembers: [
      {
        uid: "8",
        name: "Mammad Amoei",
  ...
  },
  {
    uid: 3,
    name: "سیستم طراحی",
    description: "ایجاد سیستم طراحی LMS در فیگما",
    color: "warning",
    category: "فیگما",
    progress: 87.4,
    created_at: "۲۵ شهریور ۱۴۰۰",
    teamMembers: [
      {
        uid: "6",
        name: "هنری کورتیس",
