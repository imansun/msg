  ...
  return (
    <div className="rounded-lg bg-linear-to-br from-purple-500 to-indigo-600 px-4 pb-4 text-white sm:px-5">
      <div className="flex items-center justify-between py-3">
        <h2 className="text-sm-plus font-medium tracking-wide">موجودی شما</h2>
        <ActionMenu />
      </div>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:gap-6">
        <div>
          ...
          <div className="mt-3 text-3xl font-semibold">۲۷۸,۳۰۰,۰۰۰ تومان</div>
        ...
        <div className="grid grid-cols-2 gap-4 sm:gap-5 lg:gap-6">
          <div>
            ...
            <div className="mt-1 flex items-center gap-2">
              ...
              <p className="text-base font-medium">۱۱۱,۲۶۱,۰۰۰ تومان</p>
            </div>
            <Button
              unstyled
          ...
          <div>
            ...
            <div className="mt-1 flex items-center gap-2">
              ...
              <p className="text-base font-medium">۱۱,۲۶۱,۰۰۰ تومان</p>
            </div>
            <Button
              unstyled
              className="mt-3 w-full rounded-lg border border-white/10 bg-white/20 px-5 py-2 text-white hover:bg-white/30 focus:bg-white/30 active:bg-white/25"
