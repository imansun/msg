...
export function Exchange() {
  return (
    <Card className="px-4 pb-5 sm:px-5">
      ...
      <div className="bg-gray-150 dark:bg-dark-800 dark:text-dark-200 rounded-lg text-gray-600">
        <RadioGroup
        ...
        >
          ...
          >
            ...
            <Label className="cursor-pointer">دریافت</Label>
          </Radio>
          <Radio
            value="send"
            className={({ checked }) =>
          ...
          >
            ...
            <Label className="cursor-pointer">ارسال</Label>
          </Radio>
        </RadioGroup>
      </div>
      ...
      <div className="relative">
        <div className="pt-4">
          <p className="text-xs-plus">شما ارسال می‌کنید</p>
          <div className="bg-gray-150 dark:bg-dark-800 mt-1 flex items-center justify-between gap-2 rounded-2xl p-1.5">
            <Select
              classNames={{
                root: "w-full",
                select:
                  "text-xs-plus h-8 rounded-full border-transparent py-0 dark:border-transparent",
              }}
            >
              <option>لایت کوین</option>
              <option>سولانا</option>
        ...
        <div className="pt-4">
          <p className="text-xs-plus">شما دریافت می‌کنید</p>
          <div className="bg-gray-150 dark:bg-dark-800 mt-1 flex items-center justify-between gap-2 rounded-2xl p-1.5">
            <Select
              classNames={{
                root: "w-full",
