...
export function EmployeeCard({
  ...
  return (
    <Card className="space-y-9 p-4 sm:p-5">
      <div className="flex justify-between gap-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="dark:text-dark-300 text-xs text-gray-400">کارمند</p>
          </div>
        </div>
      ...
      <div className="flex justify-between gap-2">
        <div>
          <p className="text-xs-plus">فروش</p>
          <p className="dark:text-dark-100 text-xl font-semibold text-gray-800">
            {sells}
          </p>
        </div>
        <div>
          <p className="text-xs-plus">هدف</p>
          <p className="dark:text-dark-100 text-xl font-semibold text-gray-800">
            {target}
          </p>
        </div>
        <div>
          <p className="text-xs-plus">مشتریان</p>
          <p className="dark:text-dark-100 text-xl font-semibold text-gray-800">
            {clients}
          </p>
        </div>
