  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-4 lg:gap-6">
      <Card className="flex justify-between p-4">
        <div>
          <p className="text-xs-plus uppercase">دنبال‌کنندگان جدید</p>
      ...
      <Card className="flex justify-between p-4">
        <div>
          <p className="text-xs-plus uppercase">بازدیدها</p>
          <div className="mt-8 flex items-baseline gap-1">
            <p className="text-2xl font-semibold text-gray-800 dark:text-dark-100">
              30.6m
            </p>
      ...
      <Card className="flex justify-between p-4">
        <div>
          <p className="text-xs-plus uppercase">پسندها</p>
          <div className="mt-8 flex items-baseline gap-1">
            <p className="text-2xl font-semibold text-gray-800 dark:text-dark-100">
              4.3M
            </p>
      ...
      <Card className="flex justify-between p-4">
        <div>
          <p className="text-xs-plus uppercase">گزارش‌ها</p>
          <div className="mt-8 flex items-baseline gap-1">
            <p className="text-2xl font-semibold text-gray-800 dark:text-dark-100">
              236
            </p>
