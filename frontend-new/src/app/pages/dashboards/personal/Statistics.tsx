    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-5 lg:gap-6">
      <Box className="relative flex flex-col rounded-lg bg-linear-to-r from-blue-500 to-indigo-600 px-5 pb-5">
        ...
        <p className="mt-4 text-2xl font-semibold">
          <span className="text-white">۳۱,۳۱۳</span>
          <span className="text-white/80"> تومان</span>
        </p>
        <div className="mt-2">
          <Badge
            unstyled
        ...
        <Card className="p-4.5">
          <div className="flex min-w-0 items-center justify-between">
            <div>
              ...
              <p className="text-xs-plus truncate">پروژه‌ها</p>
            </div>
            <Avatar
              size={10}
        ...
        <Card className="p-4.5">
          <div className="flex min-w-0 items-center justify-between">
            <div>
              ...
              <p className="text-xs-plus truncate">کل ساعات</p>
            </div>
            <Avatar
              size={10}
              initialColor="info"
        ...
        <Card className="p-4.5">
          <div className="flex min-w-0 items-center justify-between">
            <div>
              ...
              <p className="text-xs-plus truncate">تیکت پشتیبانی</p>
            </div>
            <Avatar
              size={10}
        ...
        <Card className="p-4.5">
          <div className="flex min-w-0 items-center justify-between">
            <div>
              ...
              <p className="text-xs-plus truncate">وظیفه فعال</p>
            </div>
            <Avatar
              size={10}
