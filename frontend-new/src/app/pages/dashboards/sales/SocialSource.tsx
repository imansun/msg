  ...
  return (
    <Card className="pb-2">
      ...
      <div className="px-4 sm:px-5">
        <p>
          <span className="dark:text-dark-100 text-2xl ml-1 text-gray-800">
            135هزار
          </span>
        ...
        <p className="text-xs-plus">بازدید در این ماه</p>
      </div>
