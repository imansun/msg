    ...
    >
      ...
      <div className="mt-2 flex-1 pt-2 text-center text-white sm:mt-0 sm:text-start">
        <h3 className="text-xl">
          خوش آمدید، <span className="font-semibold">کالب</span>
        </h3>
        <p className="mt-2 leading-relaxed">
          دانش‌آموز شما
          <span className="font-semibold text-black/90"> ۸۵٪</span> از وظایف را انجام داده است
        </p>
        <p>
          پیشرفت <span className="font-semibold">عالی</span> است!
        </p>
