...
export function CallSetting() {
  return (
    <Card className="px-4 pb-4 sm:px-5">
      ...
      <p>شما می‌توانید تنظیمات تماس خود را در این بخش مدیریت کنید.</p>
      <div className="mt-4 space-y-3.5">
        <div className="flex items-center justify-between gap-x-2">
          <span className="font-medium">گفتگوی صوتی</span>
          <Switch color="success" defaultChecked />
        </div>
        <div className="flex items-center justify-between gap-x-2">
          <span className="font-medium">گفتگوی تصویری</span>
          <Switch color="primary" defaultChecked />
        </div>
        <div className="flex items-center justify-between gap-x-2">
          <span className="font-medium">گفتگوی همزمان</span>
          <Switch color="secondary" defaultChecked />
        </div>
        <div className="flex items-center justify-between gap-x-2">
          <span className="font-medium">تماس‌های ورودی</span>
