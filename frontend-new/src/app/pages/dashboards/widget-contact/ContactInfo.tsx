...
export function ContactInfo() {
  return (
    <Card className="px-4 pb-4 sm:px-5">
      ...
      <p className="text-xs text-gray-400 dark:text-dark-300">خانواده</p>
      <div className="my-3 h-px bg-gray-200 dark:bg-dark-500"></div>
      <div className="space-y-3.5">
        <div className="flex items-center justify-between gap-2">
          <p className="truncate">22 888 4444 (01)</p>
        ...
        <div className="flex items-center justify-between gap-2">
          <p className="truncate">810-3880-(727)</p>
          <div className="flex gap-1.5">
            <Button
              variant="soft"
              color="success"
      ...
      <div className="space-y-3.5">
        <div className="flex items-center justify-between gap-2">
          <div>
            <p>۲۱ شهریور ۲۰:۳۰</p>
            <p className="text-xs">تماس ورودی</p>
          </div>
          <div>
