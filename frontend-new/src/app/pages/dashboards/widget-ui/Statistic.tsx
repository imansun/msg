    ...
    <Card className="px-4 pb-4 sm:px-5">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div className="grow leading-none">
            <div className="flex justify-between">
              ...
              <p className="text-warning dark:text-warning-light">۵۰٪</p>
            </div>
            <Progress
              classNames={{
                root: "mt-3 h-1.5",
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="grow leading-none">
            <div className="flex justify-between">
              <p className="font-medium">در حال انجام</p>
              <p className="text-primary-600 dark:text-primary-400">۷۵٪</p>
            </div>
            <Progress
              classNames={{
                root: "mt-3 h-1.5",
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="grow leading-none">
            <div className="flex justify-between">
              ...
              <p className="text-success dark:text-success-light">۲۵٪</p>
            </div>
            <Progress
              classNames={{
                root: "mt-3 h-1.5",
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="grow leading-none">
            <div className="flex justify-between">
              <p className="font-medium">لغو شده</p>
              <p className="text-error dark:text-error-light">۱۷٪</p>
            </div>
            <Progress
              classNames={{
                root: "mt-3 h-1.5",
