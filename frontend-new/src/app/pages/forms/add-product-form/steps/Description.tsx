    ...
    <form onSubmit={handleSubmit(onSubmit)} autoComplete="off">
      ...
      <div className="mt-4">
        <h6 className="dark:text-dark-100 flex gap-1.5 text-base font-medium text-gray-800">
          <span>اطلاعات سئو</span>
          <ContextualHelp
            title="اطلاعات سئو"
            content={
              <p>
                داده‌های سئو اطلاعات مرتبطی است که باید کسب‌وکار شما از آن آگاه باشد تا بتواند از تمام فرصت‌های ارائه‌شده توسط این نوع استراتژی به طور کامل بهره‌مند شود.
              </p>
            }
          />
        </h6>
        ...
        <div className="mt-3 space-y-4">
          ...
          <Textarea
            ...
            placeholder="توضیح متا را وارد کنید"
          />
          <Controller
            render={({ field: { value, onChange, ...rest } }) => (
              <MetaTags
