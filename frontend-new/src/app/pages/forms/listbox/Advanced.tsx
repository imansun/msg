...
const charactersList: Character[] = [
  {
    ...
    label: "بندر بندینگ رودریگز",
    description: "شیفته آشپزی است، با اینکه هیچ حس چشایی ندارد",
  },

  {
    ...
    label: "کارول میلر",
    description: "یکی از ثروتمندترین افراد روی زمین",
  },
  {
    id: "3",
    image: "https://img.icons8.com/clouds/256/000000/homer-simpson.png",
    label: "هومر سیمپسون",
    description: "چاق، تنبل و اغلب ناآگاه",
  },
  {
    id: "4",
    image: "https://img.icons8.com/clouds/256/000000/spongebob-squarepants.png",
    label: "باب اسفنجی",
    description: "تنها یک اسفنج نیست",
  },
];
