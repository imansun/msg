...
// Local Imports
import { TextEditor, TextEditorRef } from "@/components/shared/form/TextEditor/TextEditor";
...
const Instance = () => {
  ...
  return (
    <div className="max-w-xl">
      <TextEditor ref={ref} placeholder="محتوای خود را اینجا وارد کنید..." />
      <p className="mt-1 text-end text-xs">{wordLength} کلمه</p>
    </div>
  );
};
