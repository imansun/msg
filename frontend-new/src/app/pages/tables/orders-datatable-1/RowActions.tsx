...
const confirmMessages: ConfirmMessages = {
  pending: {
    description:
      "آیا مطمئن هستید که می‌خواهید این سفارش را حذف کنید؟ پس از حذف، امکان بازیابی آن وجود ندارد.",
  },
  success: {
    title: "سفارش حذف شد",
  },
            ...
            >
              ...
              <MenuItem>
                {({ focus }) => (
                  <button
                    className={clsx(
                      "flex h-9 و-full items-center space-x-3 px-3 tracking-wide outline-hidden transition-colors",
                      focus &&
                        "dark:bg-dark-600 dark:text-dark-100 bg-gray-100 text-gray-800",
                    )}
                  >
