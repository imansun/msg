            ...
            >
              ...
              <MenuItem>
                {({ focus }) => (
                  <button
                    className={clsx(
                      "flex h-9 و w-full items-center px-3 tracking-wide outline-hidden transition-colors",
                      focus &&
                        "dark:bg-dark-600 dark:text-dark-100 bg-gray-100 text-gray-800",
                    )}
                  >
              ...
              <MenuItem>
                {({ focus }) => (
                  ...
                  >
                    <span>ذخیره جدول به عنوان نما</span>
                  </button>
                )}
              </MenuItem>
            </Transition>
              ...
              >
                ...
                <MenuItem>
                  {({ focus }) => (
                    ...
                    >
                      <span>اشتراک‌گذاری سفارش‌ها</span>
                    </button>
                  )}
                </MenuItem>
                <hr className="border-gray-150 dark:border-dark-500 mx-3 my-1.5 h-px" />
                ...
                <hr className="border-gray-150 dark:border-dark-500 mx-3 my-1.5 ه-px" />
                <MenuItem>
                  {({ focus }) => (
                    <button
                      className={clsx(
...
function SearchInput({ table }: { table: Table<Order> }) {
  return (
    <Input
      ...
      placeholder="جستجوی شناسه، مشتری..."
    />
  );
}
