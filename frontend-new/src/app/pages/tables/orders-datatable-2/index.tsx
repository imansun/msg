  ...
  return (
    <div className="transition-content grid grid-cols-1 grid-rows-[auto_auto_1fr] px-(--margin-x) py-4">
      ...
      <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4 lg:grid-cols-6 2xl:gap-6">
        <div className="bg-gray-150 dark:bg-dark-700 rounded-lg پ-3 2xl:p-4">
          ...
          <p className="text-xs-plus mt-1">کل درآمد</p>
        </div>
        <div className="bg-gray-150 dark:bg-dark-700 rounded-lg p-3 2xl:p-4">
          ...
          <p className="text-xs-plus mt-1">سفارش تکمیل شده</p>
        </div>
        <div className="bg-gray-150 dark:bg-dark-700 rounded-lg p-3 2xl:p-4">
          <div className="flex justify-between space-x-1">
            <p className="dark:text-dark-100 text-xl font-semibold text-gray-800">
          ...
          <p className="text-xs-plus mt-1">در حال پردازش</p>
        </div>
        <div className="bg-gray-150 dark:bg-dark-700 rounded-lg p-3 2xl:p-4">
          <div className="flex justify-between space-x-1">
            <p className="dark:text-dark-100 text-xl font-semibold text-gray-800">
          ...
          <p className="text-xs-plus mt-1">در انتظار تایید</p>
        </div>
        <div className="bg-gray-150 dark:bg-dark-700 rounded-lg p-3 2xl:p-4">
          <div className="flex justify-between space-x-1">
            <p className="dark:text-dark-100 text-xl font-semibold text-gray-800">
          ...
          <p className="text-xs-plus mt-1">در حال ارسال</p>
        </div>
        <div className="bg-gray-150 dark:bg-dark-700 rounded-lg p-3 2xl:p-4">
          <div className="flex justify-between space-x-1">
            <p className="dark:text-dark-100 text-xl font-semibold text-gray-800">
          ...
          <p className="text-xs-plus mt-1">لغو شده</p>
        </div>
      </div>
      <div
        className={clsx(
