            ...
            >
              ...
              <MenuItem>
                {({ focus }) => (
                  ...
                  >
                    <span>ذخیره جدول به صورت نما</span>
                  </button>
                )}
              </MenuItem>
            </Transition>
          ...
          <div className="flex space-x-2">
            ...
            >
              ...
              <Transition
                ...
                leaveFrom="opacity-100 translate-y-0"
                leaveTo="opacity-0 translate-y-2"
                className="dark:border-dark-500 dark:bg-dark-700 absolute z-100 mt-1.5 min-w-[10rem] rounded-lg border border-gray-300 bg-white py-1 shadow-lg shadow-gray-200/50 outline-hidden focus-visible:outline-hidden لtr:right-0 rtl:left-0 dark:shadow-none"
              >
                <MenuItem>
                  {({ focus }) => (
                    <button
...
function SearchInput({ table }: { table: Table<User> }) {
  return (
    <Input
      ...
      placeholder="جستجو در درس، دسته‌بندی..."
    />
  );
}
